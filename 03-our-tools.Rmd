...
```{r}
# %![Plots Window with a Demo Plot](images/plots.png)
```
...
```{r}
help("help")
# %![Help Window when looking for help on "help"](images/help.png)
```
...
```{r}
# %![Line Continuation for Incomplete Commands](images/incomplete.png)
```
