...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# %![History Window](images/history.png)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# %![Files Window](images/files.png)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# %![Plots Window with a Demo Plot](images/plots.png)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# %![Help Window when looking for help on "help"](images/help.png)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# %![Line Continuation for Incomplete Commands](images/incomplete.png)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# %![Figure: RMD Startup Dialog](RMDStart.png)}
\end{Highlighting}
\end{Shaded}
